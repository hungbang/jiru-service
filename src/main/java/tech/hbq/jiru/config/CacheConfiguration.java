...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tech.hbq.jiru.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tech.hbq.jiru.repository.UserRepository.USERS_BY_EMAIL_CACHE);
