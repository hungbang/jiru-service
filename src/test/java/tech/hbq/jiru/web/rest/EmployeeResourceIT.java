...
import tech.hbq.jiru.repository.EmployeeRepository;
import tech.hbq.jiru.service.dto.EmployeeDTO;
import tech.hbq.jiru.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).nickName(UPDATED_NICK_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).nickName(UPDATED_NICK_NAME).email(UPDATED_EMAIL);
