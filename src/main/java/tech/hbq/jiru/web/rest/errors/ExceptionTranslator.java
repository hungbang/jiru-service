package tech.hbq.jiru.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof tech.hbq.jiru.service.EmailAlreadyUsedException ||
            ex instanceof tech.hbq.jiru.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof tech.hbq.jiru.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "tech.hbq.jiru");
    }
}
