...
import tech.hbq.jiru.repository.ProjectRepository;
import tech.hbq.jiru.service.ProjectService;
...
/**
 * REST controller for managing {@link tech.hbq.jiru.domain.Project}.
 */
@RestController
@RequestMapping("/api")
